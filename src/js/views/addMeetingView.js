class AddMeetingView {
  ...
  addHandlerShowError(el) {
    ...
    el.querySelector('.error__btn-close').addEventListener(this._toggleErrorMessage.bind(this));
  }
      ...
      formWindow.addEventListener('load', function() {
        ...
        form.addEventListener('submit', function(evt) {
          ...
          if (handler(data)) {
            ...
            error.querySelector('.error__btn-close').addEventListener('click', function() {
